package com.definitelyscala.node.constants

import scala.scalajs.js
@js.native
@js.annotation.JSGlobal("constants")
object Constants extends js.Object {
  ...
  var SSL_OP_NO_SSLv2: Double = js.native
  var SSL_OP_NO_SSLv3: Double = js.native
  var SSL_OP_NO_TICKET: Double = js.native
  var SSL_OP_NO_TLSv1: Double = js.native
  var SSL_OP_NO_TLSv1_1: Double = js.native
  var SSL_OP_NO_TLSv1_2: Double = js.native
  ...
  var O_SYMLINK: Double = js.native
  ...
  var defaultCoreCipherList: String = js.native
  var defaultCipherList: String = js.native
  var ENGINE_METHOD_RSA: Double = js.native
  var ALPN_ENABLED: Double = js.native
}